	...
	************************************************************************************************************/
	...
	var imageGalleryDescriptions = new Array();
	...
	function showPreview(newSrc,imageIndex)
	{
		...
		document.getElementById('largeImageDescription').style.display='none';
	...
	function hideWaitMessageAndShowCaption(imageIndex)
	{
		...
		document.getElementById('largeImageDescription').innerHTML = imageGalleryDescriptions[imageIndex];
		document.getElementById('largeImageDescription').style.display='block';
	}	
	...
	function initGalleryScript()
	{
		...
		for(var no=0;no<divs.length;no++){
			...
			if(divs[no].className=='imageDescription')imageGalleryDescriptions[imageGalleryDescriptions.length] = divs[no].innerHTML;
		}		
		slidePreviewPane();
