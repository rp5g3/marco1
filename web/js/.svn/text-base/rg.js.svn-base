...
function ValRG(numero){
	...
	if(tamanho>=9){
	 ...
	 resto = total % 11;
	if(resto!=0){		
		document.getElementById('rg').innerHTML="<font face=verdana size=2 color=red>RG Inválido!</font><br><br>";
		alert('O RG não está preencido corretamente');
	}
	else{
		document.getElementById('rg').innerHTML="<font face=verdana size=2 color=forestgreen>RG Válido!</font><br><br>";
	}
}
