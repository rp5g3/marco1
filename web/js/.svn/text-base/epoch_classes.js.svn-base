...
{
	this.daylist = new Array('Do','Se','Te','Qa','Qi','Se','Sa','Do','Se','Te','Qa','Qi','Se','Sa'); /*<lang:en>*/
	this.months_sh = new Array('Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez');
	this.monthup_title = 'Ir para o proximo mês';
	this.monthdn_title = 'Ir para o mês anterior';
	this.clearbtn_caption = 'Limpar';
	this.clearbtn_title = 'Limpa quaisquer datas selecionadas no calendário';
	this.maxrange_caption = 'Este é o tamanho máximo';
};
//-----------------------------------------------------------------------------
