...
<a 	onclick="modalImageWin('fullImage.html?image_id=<%=imdet.getId()%>','Imagem image_id=<%=imdet.getRotulo()%>'); return false;"
	...
	<img src="comercialSolutionBigImage.html?image_id=<%=imdet.getId()%>" alt="Carregando a Imagem ... Por favor, espere." title="Clique para visualizar a imagem em tamanho original">
</a>
</center>