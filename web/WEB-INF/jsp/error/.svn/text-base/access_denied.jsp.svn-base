			...
			padding-top:5px; padding-right: 20px;
			 background-color:#1a1a1a; height: 29px;" align="left">
				...
				<%if(udto != null){ %>
					...
					| 
					<a class="white_link" href="" target="_blanck"
					onClick="jqueryOpen('loginUsuario.html?init=true','contentDiv'); return false;">Acessar os cadastros</a>
					<%} else{%>
					<a class="white_link" href="" target="_blanck"
						 ...
						 background-color: #2a2a2a; background-image: url(imgs/contentdarkbg.jpg); background-repeat: repeat-x;
						  ...
						  <dir style="padding: 10px;">		
						  	<div class="panel_title ui-corner-top">
								<font class="font_title"><b>&nbsp;&nbsp;Arquivo de Acesso Restrito</b></font>
							</div>
							<div class="panel_content ui-corner-bottom" style="padding-left:10px;padding-right:10px;padding-bottom:10px;padding-top:10px;">
								<h2>Voc&ecirc; n&atilde;o tem acesso &agrave; essa p&aacute;gina/arquivo!</h2>
								<p>Para acessar o item &eacute; necess&aacute;rio estar logado no sistema. Caso n&atilde;o 
								estejas logado no sistema, acesse-o com seu login e senha e tente novamente.
								<a href="" onclick="jqueryOpen('loginUsuario.html?init=true','contentDiv'); return false;">Acessar o sistema</a></p>
							</div>
						</dir>																		
					</div>
				</td>
