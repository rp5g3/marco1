					...
					<div id="contentDiv" class="ui-corner-all"
						...
						<div  class="default_window"  style=" width:944px;  position:relative; top:0px; left:0px; " >
								<div  class="default_crud   ui-corner-all "  style=" width:909px; height:100px;  left:15px; position:relative;  top:0px; " >
									...
									<span>Recomenda&ccedil;&atilde;o de Usu&aacute;rios</span>
									</div>
									<div  style=" width:886px; height:80px;  left:15px; position:absolute;  top:33px; " >
										...
										<p><%=msg %></p>
										<%}else { %>
											<p>Para nos recomendar para seus conhecidos, informe o email de seus contatos e separe-os com espa&ccedil;os ou v&iacute;rgulas</p>
											<form action="http://www.adapit.com.br/recomendation.html?part_id=<%=udto!=null?udto.getParticipanteId():0 %>">
											<input type="text" id="contact_email" name="contact_email" style="width:100%; height:24px;"/>
											<label for="contact_email">Liste os contatos</label>
