...
public class AdapitVirtualFrame extends JFrame {
	...
	public void editarImagem(final Imagem im) {
		SwingWorker sw = new SwingWorker(){
			...
			public Object construct() {
				try {
					TimerMessageFrame jd = new TimerMessageFrame("Carregando informa��es ... por favor aguarde");
					jd.setSize(310,80);					
					jd.setVisible(true);
	...
	public void newComercialSolution() {
		beginStatusBar("Cadastrar Solu��es");
		...
		endStatusBar("Cadastrar Solu��es");
	}
	...
	public void newSoftwareDomain() {
		beginStatusBar("Cadastrar Dom�nios de Software");
		...
		endStatusBar("Cadastrar Dom�nios de Software");
	}
	...
	public void relatorioTreinamentos(){
		beginStatusBar("Relat�rio de treinamentos");
	...
	public void relatorioTurmas(){
		...
		endStatusBar("Relat�rio de turmas");
	}
	...
	public void listarUsuarios() {
		beginStatusBar("Listar Usu�rios");
		javax.swing.JInternalFrame gui = new javax.swing.JInternalFrame("Listar Usu�rios");
	...
	public void showOperationSucess(){
		JOptionPane.showMessageDialog(this,"A opera��o foi realizada com sucesso!", "Opera��o realizada com sucesso", JOptionPane.INFORMATION_MESSAGE);
	}
	
	public void showOperationSucess(String title){
		JOptionPane.showMessageDialog(this,"A opera��o foi realizada com sucesso!", title, JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public void showErrorCamposInvalidos(){
		JOptionPane.showMessageDialog(this,"O formul�rio n�o foi preenchido corretamente!", "Dados incorretos", JOptionPane.ERROR_MESSAGE);
	}
	
	public void showErrorCamposInvalidosWithinTabs(){
		JOptionPane.showMessageDialog(this,"O formul�rio n�o foi preenchido corretamente!", "Dados incorretos nas abas em destaque", JOptionPane.ERROR_MESSAGE);
	}
	
	public void showErrorCamposInvalidos(String title){
		JOptionPane.showMessageDialog(this,"O formul�rio n�o foi preenchido corretamente!", title, JOptionPane.ERROR_MESSAGE);
	}
	...
	public void novaFormacao(){
		beginStatusBar("Cadastrar forma��es");
		...
		endStatusBar("Cadastrar forma��es");
	}
		...
		SwingWorker sw = new SwingWorker(){
			...
			public Object construct() {
				try {
					...
					jd.setSize(310,80);					
					jd.setVisible(true);
					beginStatusBar("Editar forma��es");
					if (lastCadastroFormacaoInternalFrame != null){
	...
	public Instrutor getLeiloeiro() {
		if (leiloeiro == null){
			TelaLoginUsuario login = TelaLoginUsuario.getInstance("Opera��o permitida somente para leiloeiros",true,false);			
	...
	public Participante getParticipante() {
		if (participante == null){
			TelaLoginUsuario login = TelaLoginUsuario.getInstance("Opera��o permitida somente para participantes",true,false);			
			if (login.getUsuarioDTO() == null) login.setVisible(true);
			else try {
	...
	public Funcionario getFuncionario() {
		if (funcionario == null){
			TelaLoginUsuario login = TelaLoginUsuario.getInstance("Opera��o permitida somente para Funcionarios",true,false);			
			if (login.getUsuarioDTO() == null) login.setVisible(true);
			else try {
	...
	public PessoaEmDivulgacao getComitente() {
		if (pessoaEmDivulgacao == null){
			TelaLoginUsuario login = TelaLoginUsuario.getInstance("Opera��o permitida somente para comitentes",true,false);			
			if (login.getUsuarioDTO() == null) login.setVisible(true);
			else try {
...
/*	public void editarDadosPessoais(){
	...
	public void destaque() {
		...
		jif.setTitle("Destaques da P�gina");
	...
	public void showArquivosFrame() {
		...
		jif.setDefaultCloseOperation(JInternalFrame.DISPOSE_ON_CLOSE);
		jif.setClosable(true);
		jif.setTitle("Manuten��o de Arquivos do Servidor");
	...
	public void novoUpdate(final ComercialSolution c) {
		beginStatusBar("Cadastrar vers�o");
	...
	/**
	 * Cria um di�logo padr�o
	 * @param title o t�tulo do di�logo
	 * @param content o painel de conte�do
	 * @param buttons a lista dos bot�es
	 * @param listeners a lista dos listeners dos bot�es
	 * @param icons os �cones dos bot�es
	 * @param w width
	 * @param h heigth
	 * @param modal � modal
	 * @param center true � colocado no centro e false � maximizado
	 * @return
	 */
	...
	/**
	 * Cria um internal frame padr�o
	 * @param title o t�tulo do frame
	 * @param content o painel de conte�do
	 * @param buttons a lista dos bot�es
	 * @param listeners a lista dos listeners dos bot�es
	 * @param icons os �cones dos bot�es
