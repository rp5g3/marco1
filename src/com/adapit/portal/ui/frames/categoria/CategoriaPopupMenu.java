...
public class CategoriaPopupMenu extends JPopupMenu {
	
	private final CategoriasTreeController controller;

	public CategoriaPopupMenu(CategoriasTreeController controller){
