...
public class AgendaListaTreinamentoDialog extends JDialog {
	...
	public AgendaListaTreinamentoDialog() {
		super();
	...
	public static void main(String args[]) {
		...
		new java.lang.Thread(new Runnable() {
			public void run() {
				AgendaListaTreinamentoDialog gui = new AgendaListaTreinamentoDialog();
	...
	private class UsuarioHistoricoLancezTable extends JTable {
		...
		private class UsuarioHistoricoLancezTablePropertyChangeListener
			...
			public void propertyChange(PropertyChangeEvent e) {
				...
				com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.UsuarioHistoricoLancezTable jt = (com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.UsuarioHistoricoLancezTable) e
						.getSource();
	...
	private class AgendasTable extends JTable {
		...
		private class AgendasTablePropertyChangeListener implements
			...
			public void propertyChange(PropertyChangeEvent e) {
				...
				com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.AgendasTable jt = (com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.AgendasTable) e
						.getSource();
				//int col = jt.getSelectedColumn();
				int row = jt.getSelectedRow();
				if (jt.getElements() != null && row > -1)
	...
	private class LancesTable extends JTable {
		...
		private class LancesTablePropertyChangeListener implements
			...
			public void propertyChange(PropertyChangeEvent e) {
				...
				com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.LancesTable jt = (com.adapit.portal.ui.forms.treinamento.agenda.AgendaListaTreinamentoDialog.LancesTable) e
						.getSource();
				//int col = jt.getSelectedColumn();
				int row = jt.getSelectedRow();
				if (jt.getElements() != null && row > -1)
