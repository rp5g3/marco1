...
public class NewsDescricaoPropertyEditorDialog extends JDialog {

	private static final long serialVersionUID = 2312531253L;
	private JPanel jContentPane = null;


	public NewsDescricaoPropertyEditorDialog(JFrame frame) {
		super(frame);
		initialize();
	}
	...
	private void initialize() {
		...
		this.setModal(true);
		this.setTitle("Editor de descrição de news");
	...
	public static void main(String args[]){
		...
		jb.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				NewsDescricaoPropertyEditorDialog p = new NewsDescricaoPropertyEditorDialog(jf);
				p.setVisible(true);
			}
