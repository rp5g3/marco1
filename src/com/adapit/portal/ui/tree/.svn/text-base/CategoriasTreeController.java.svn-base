...
import com.adapit.portal.ui.frames.categoria.CategoriaPopupMenu;

public class CategoriasTreeController implements MouseListener, MouseMotionListener, ActionListener, FocusListener{
	...
	protected CategoriaPopupMenu popup;

	protected JTree tree;
	
	protected CategoriaInternalFrame observer;

	public CategoriasTreeController(CategoriaInternalFrame observer) {
		super();
	...
	public CategoriaPopupMenu getDefaultPopup() {
		popup = new CategoriaPopupMenu(this);
		return popup;
	}
	...
	public CategoriaInternalFrame getObserver() {
		return observer;
	}
