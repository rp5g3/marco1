...
public class UserServiceDAOHibernate extends GenericDAOHibernate implements
	...
	/**
	 * retorna todos os usu�rio que alguma vez j� foram desativados
	 */
	...
	/**
	 * retorna todos os usu�rios que s�o do tipo de pessoa juridica
	 */
	...
	/**
	 * retorna todos os usu�rios que s�o do tipo de pessoa f�sica
	 */
	...
	/**
	 * Remove o usu�rio pelo identificador da tabela
	 */
	...
	/**
	 * Remove o usu�rio pelo login de usu�rio
	 */
	...
	/**
	 * Remove o usu�rio pela senha de usu�rio
	 */
	...
	/**
	 * Retorna o usu�rio pelo identificador da tabela
	 */
	...
	/**
	 * Retorna o usu�rio pelo login e senha e estado de ativa��o
	 */
	...
	/**
	 * Retorna o usu�rio pelo login e senha
	 */
	...
	public List<LoteReportDTO> getLotesParticipacao(String userid) throws Exception{
		...
		try {
			...
			if (p == null){
				System.out.println("N�o encontrou o participante");
				return new ArrayList();
			}
			else if (p.getMeusTreinamentos() == null){
				System.out.println("N�o existem lotes de prefer�ncia desse participante");
				return new ArrayList();
			}
			...
			while (it.hasNext()) {
				...
				if (sa == null){
					...
					lrd.setStatus(StatusAgenda.Em_execu��o_no_leil�o_1);
				}
				else{
					if (sa != StatusAgenda.Cancelada &&
							sa != StatusAgenda.Em_execu��o_no_leil�o_1 && 
							sa != StatusAgenda.Em_execu��o_no_leil�o_2)
						lrd.setLeilaoIniciou(false);
				...
				/*String queryCount = "Select lance.valor From Lance lance, AgendaLote a where a.id="
						...
						+ l.getId()
						+ " and a.status<>"
						+ StatusAgenda.Encerrada_final_leil�o_1.ordinal()
						+ " and a.status<>"
						+ StatusAgenda.Encerrada_final_leil�o_2.ordinal()
