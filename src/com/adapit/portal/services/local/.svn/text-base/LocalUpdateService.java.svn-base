...
public class LocalUpdateService implements UpdateService {

	private UpdateService updateService;

	private static LocalUpdateService instance;

	private LocalUpdateService() {
		try {
			XmlBeanFactory beanFactory = new XmlBeanFactory(new ClassPathResource("localServices.xml"));
			updateService = (UpdateService) beanFactory.getBean("updateServiceDAOHibernate");//new LoteServiceDAOHibernate();
	...
	public static LocalUpdateService getInstance() {
		if (instance == null) {
			instance = new LocalUpdateService();
		}
		return instance;
	}
	...
	public Update deleteById(int id) throws Exception {
		try {
			...
			ex.printStackTrace();
			throw new Exception("RemoteUpdateService_deleteByIdError");
		}
	}
	...
	public Update getUpdateById(int id) throws Exception {
		try {
			...
			ex.printStackTrace();
			throw new Exception("RemoteUpdateService_getUpdateByIdError");
		}
	}
	...
	public Update getUpdateByDescricao(String descricao, ComercialSolution c) throws Exception {
		try {
			...
			ex.printStackTrace();
			throw new Exception(
					"RemoteUpdateService_getUpdateByDescricaoError");
		}
	}
