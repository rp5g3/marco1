...
public class RemoteComercialSolutionService implements ComercialSolutionService {

	private ComercialSolutionService comercialSolutionService;

	private static RemoteComercialSolutionService instance;

	private RemoteComercialSolutionService() {
		try {
			XmlBeanFactory beanFactory = SwingContext.getInstance()
					.getBeanFactory();
			comercialSolutionService = (ComercialSolutionService) beanFactory
					.getBean("remoteComercialSolutionServiceHttpInvokerProxy");
	...
	public static RemoteComercialSolutionService getInstance() {
		if (instance == null) {
			instance = new RemoteComercialSolutionService();
		}
		return instance;
	}
