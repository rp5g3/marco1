...
/**
 * @spring.bean id="utilityService" singleton="true"
 */
public class UtilityServiceValidator extends AbstractValidator implements
		UtilityService {
	...
	public void setUtilityService(UtilityService uService) {
		this.utilityService = uService;
	}

	/**
	 * @spring.property ref="utilityDAOHibernate" singleton="true"
	 */
	public UtilityService getUtilityService() {
		return this.utilityService;
	}

	public UtilityServiceValidator() {
		super();
		setName("utilityServiceValidator");
	}
