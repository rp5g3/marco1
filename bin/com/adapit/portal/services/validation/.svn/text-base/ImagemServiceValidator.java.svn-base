...
/**
 * @spring.bean id="imagemService" singleton="true"
 */
public class ImagemServiceValidator extends AbstractValidator implements ImagemService {
	...
	public void setImagemService(ImagemService imService) {
		this.imagemService = imService;
	}

	/**
	 * @spring.property ref="imagemServiceDAOHibernate" singleton="true"
	 */
	public ImagemService getImagemService() {
		return this.imagemService;
	}

	public ImagemServiceValidator() {
		super();
		setName("imagemServiceValidator");
	}
