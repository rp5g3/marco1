...
public class PublicationDescricaoPropertyEditorDialog extends JDialog {

	private static final long serialVersionUID = 2312531253L;
	private JPanel jContentPane = null;


	public PublicationDescricaoPropertyEditorDialog(JFrame frame) {
		super(frame);
		initialize();
	}
	...
	private void initialize() {
		...
		this.setModal(true);
		this.setTitle("Editor de Descrição de Artigo");
	...
	public static void main(String args[]){
		...
		jb.addActionListener(new ActionListener(){
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				PublicationDescricaoPropertyEditorDialog p = new PublicationDescricaoPropertyEditorDialog(jf);
				p.setVisible(true);
			}
