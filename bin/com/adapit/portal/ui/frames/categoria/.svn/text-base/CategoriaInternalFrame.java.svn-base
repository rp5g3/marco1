...
import com.adapit.portal.ui.forms.categoria.CategoriaCadastreForm;
import com.adapit.portal.ui.frames.AdapitVirtualFrame;
import com.adapit.portal.ui.tree.CategoriasTreeController;
...
public class CategoriaInternalFrame extends JInternalFrame {
	...
	private CategoriaToolbar treeToolBar = null;
	private JScrollPane treeScrollPane = null;
	private JTree jTree = null;

	private Categoria selectedElement;  //  @jve:decl-index=0:
	
	private static CategoriaInternalFrame instance;
	/**
	...
	private void initialize() {
		...
		this.addInternalFrameListener(new InternalFrameAdapter(){
			...
			public void internalFrameClosed(InternalFrameEvent arg0) {
				AdapitVirtualFrame.getInstance().setCategoriaInternalFrame(null);
			}
		});
	}
	...
	private CategoriaCadastreForm ccf;
	
	public CategoriaCadastreForm getCcf(){
		if (ccf == null){
			ccf = new CategoriaCadastreForm(this);
		}
		 return ccf;
	}
	/**
	...
	private JToolBar getTreeToolBar() {
		if (treeToolBar == null) {
			treeToolBar = new CategoriaToolbar(this);
		}
		return treeToolBar;
	}
	...
	private CategoriasTreeController categoriasTreeController;
	/**
	...
	public CategoriasTreeController getCategoriasTreeController(){
		if (categoriasTreeController == null){
			categoriasTreeController = new CategoriasTreeController(this);
		}
	...
	public void removeCategoria(){
		if (selectedElement != null && selectedElement.getPai() != null){
			...
			if (e.getMessage() != null && e.getMessage().equals("RemoteCategoriaService_deleteByIdError")){
				JOptionPane.showMessageDialog(CategoriaInternalFrame.this,"Para remover esta categoria, primeiro remova todos os produtos desta categoria!","Erro de integridade referencial",JOptionPane.ERROR_MESSAGE);
				return;
			}
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public static CategoriaInternalFrame getInstance() {
		if (instance==null) instance= new CategoriaInternalFrame();
		return instance;
	}
