  ...
  extends CommonsHttpInvokerRequestExecutor
{
      ...
      throws IOException, ClassNotFoundException
  {
    ...
    if(wbaos.getRemoteInvocation() instanceof StreamSupportingRemoteInvocation) {
      return doExecuteRequest(config, wbaos, (StreamSupportingRemoteInvocation)wbaos.getRemoteInvocation());
    } else {
...
protected RemoteInvocationResult doExecuteRequest(final HttpInvokerClientConfiguration config, final ByteArrayOutputStream baos, final StreamSupportingRemoteInvocation invocation)
      throws IOException, ClassNotFoundException
  {
